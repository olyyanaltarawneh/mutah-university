...
const CAMPUS_DB_DEFAULT = [
  ...
  {id:6,  name:"المكتبة ",         type:"library",  x:-0.5,  z:-7,   w:3.2, d:2.2, h:4, rot:0, color:0xd5e8f0},
  ...
  {id:15, name:"المجمع  الإداري", type:"admin",    x:-14.5, z:-2.5, w:2.0, d:1.6, h:3, rot:0, color:0xe8dfc8},
  {id:16, name:"النافورة",  type:"plaza",    x:0,     z:0.5,  w:4.0, d:4.0, h:0, rot:0, color:0x3a9060, isPlaza:true},
